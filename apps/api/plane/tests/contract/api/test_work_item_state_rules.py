...
they may cancel them and use custom states freely. An unassigned ``[Human]`` work item has its own
bot table: Todo -> Awaiting Human exists only there, and nothing leads out of Awaiting Human.
"""
